...
function Faq() {
    return (
        <div id="faq" className="py-16 bg-faq  bg-cover faqBackground relative bg-center" style={{boxShadow: '0 30px 20px 10px #B1C6FF inset'}} >
            ...
            <h1 className='font-irish text-[26px] md:text-[32px]  text-center leading-[70px] text-white mb-4 md:mb-12 font-semibold tracking-wider'>FAQ</h1>
